            ...
            <FieldGroup>
              <Field>
                ...
                <label className="cursor-pointer">
                  {imagePreview ? (
                    <div className="relative w-full h-48 rounded-lg border-2 border-dashed border-[#dabcac] overflow-hidden bg-[#F2E8DB]">
                      <img
                        src={imagePreview}
                        alt="Pet preview"
                    ...
                    <div className="w-full h-48 rounded-lg border-2 border-dashed border-[#dabcac] flex flex-col items-center justify-center bg-[#F2E8DB] hover:border-[#C4622D] transition-colors">
                      <Upload className="w-10 h-10 text-[#7A6150]/50 mb-2" />
                      <span className="text-sm text-[#7A6150]/70">Click to upload photo</span>
                    </div>
                  )}
                  <input
                    type="file"
