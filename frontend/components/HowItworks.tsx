    ...
    <div className="min-h-screen bg-[#FDF6EE]">
      <div className="bg-[#FFFAF4] border-b border-[#dabcac] py-14 lg:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-gray-900 mb-4 font-bold" style={{ fontFamily: "var(--font-dm-serif)", fontSize: 'clamp(1.9rem, 4vw, 2.75rem)', lineHeight: '1.2' }}>
            How the Adoption Process Works
          </h1>
          <p className="text-[#7A6150] max-w-2xl mx-auto leading-relaxed" style={{ fontSize: '1.05rem' }}>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-14 space-y-16">
        ...
        <section>
          <div className="flex items-center gap-3 mb-8">
            <div className="flex-1 h-px bg-[#dabcac]" />
            <h2 className="text-[#7A6150] font-semibold text-sm uppercase tracking-widest">The Adoption Journey</h2>
            <div className="flex-1 h-px bg-[#dabcac]" />
          </div>
            ...
            {[
              {
                ...
                color: 'bg-[#C4622D]/10 text-[#C4622D] border-[#dabcac]',
                accent: 'border-l-[#C4622D]',
              ...
              },
              {
                ...
                color: 'bg-[#E8DDD3] text-[#7A6150] border-[#dabcac]',
                accent: 'border-l-[#7A6150]',
              ...
              <div key={item.step} className={`bg-white border border-[#dabcac] border-l-4 ${item.accent} rounded-2xl overflow-hidden`}>
                <div className="p-6 sm:p-8">
                  <div className="flex items-start gap-5">
                    <div className="flex flex-col items-center gap-2 shrink-0">
                      ...
                      {i < 5 && <div className="w-px flex-1 bg-[#dabcac] min-h-6" />}
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-2">
                        <span className="text-[#7A6150]/50 font-bold" style={{ fontFamily: "var(--font-dm-serif)", fontSize: '1.1rem' }}>Step {item.step}</span>
                      </div>
                      <h3 className="text-gray-900 mb-3 font-semibold" style={{ fontFamily: "var(--font-dm-serif)", fontSize: '1.25rem' }}>{item.title}</h3>
                      <p className="text-[#7A6150] text-sm leading-relaxed mb-4">{item.desc}</p>
                      <ul className="grid sm:grid-cols-2 gap-x-6 gap-y-1.5">
                        {item.details.map((d, j) => (
                          <li key={j} className="flex items-start gap-2 text-xs text-gray-900">
                            <CheckCircle2 className="w-3.5 h-3.5 text-[#4A7C59] shrink-0 mt-0.5" />
                            {d}
                          </li>
                        ))}
                      </ul>
        ...
        <section className="bg-[#C4622D]/5 border border-[#C4622D]/15 rounded-2xl p-8">
          <div className="flex items-start gap-5">
            <div className="w-12 h-12 rounded-2xl bg-[#C4622D]/10 flex items-center justify-center shrink-0">
              <Shield className="w-6 h-6 text-[#C4622D]" />
            </div>
            <div>
              <h3 className="text-gray-900 mb-2 font-semibold" style={{ fontFamily: "var(--font-dm-serif)", fontSize: '1.3rem' }}>Why Two Rounds of Screening?</h3>
              <p className="text-[#7A6150] text-sm leading-relaxed mb-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-white border border-[#dabcac] rounded-xl p-4">
                  <p className="text-gray-900 font-semibold text-sm mb-1">Round 1 — Your Profile</p>
                  <p className="text-[#7A6150] text-xs leading-relaxed">Universal across all applications. Covers your lifestyle, home environment, and experience. Saved once, used forever. Powers pet recommendations.</p>
                </div>
                <div className="bg-white border border-[#dabcac] rounded-xl p-4">
                  <p className="text-gray-900 font-semibold text-sm mb-1">Round 2 — Pet-Specific</p>
                  <p className="text-[#7A6150] text-xs leading-relaxed">Custom questions written by the center for each individual pet. Addresses that animal&apos;s unique history, temperament, and care requirements.</p>
                </div>
              </div>
              <p className="text-[#7A6150] text-xs mt-4">Together, these two rounds dramatically reduce post-adoption returns and ensure animals go to truly compatible homes.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="flex items-center gap-3 mb-8">
            <div className="flex-1 h-px bg-[#dabcac]" />
            <h2 className="text-[#7A6150] font-semibold text-sm uppercase tracking-widest">After You Adopt</h2>
            <div className="flex-1 h-px bg-[#dabcac]" />
          </div>

          <div className="grid lg:grid-cols-2 gap-6 items-start">
            <div>
              <h3 className="text-gray-900 mb-3 font-semibold" style={{ fontFamily: "var(--font-dm-serif)", fontSize: '1.5rem' }}>
                We Stay With You After Adoption Day
              </h3>
              <p className="text-[#7A6150] text-sm leading-relaxed mb-6">
              ...
              <div className="space-y-4">
                {[
                  { icon: <Bell className="w-4 h-4 text-[#C4622D]" />, label: 'Smart Care Reminders', desc: 'Automated alerts for vaccine boosters, monthly flea prevention, heartworm medication, and vet visits — delivered to your dashboard on schedule.' },
                  { icon: <Clock className="w-4 h-4 text-[#C4622D]" />, label: 'Scheduled Vet Prompts', desc: 'Check-in reminders at 1-week, 1-month, and 3-month marks so no health milestone is missed in your pet\'s critical early period.' },
                  { icon: <ClipboardList className="w-4 h-4 text-[#7A6150]" />, label: 'Follow-up Surveys', desc: 'Three short well-being surveys after adoption where you share how your pet is settling in. The center reviews every response.' },
                  { icon: <MessageSquare className="w-4 h-4 text-[#7A6150]" />, label: 'Ongoing Chat Access', desc: 'Have questions about diet, behavior, or health? Your chat line with the center stays open long after the adoption is completed.' },
                  { icon: <Users className="w-4 h-4 text-[#7A6150]" />, label: 'Center Support Team', desc: 'Our team flags follow-up responses that need attention, so help reaches you before small issues become big ones.' },
                ].map((f, i) => (
                  <div key={i} className="flex items-start gap-4 p-4 bg-white border border-[#dabcac] rounded-xl">
                    <div className="w-9 h-9 rounded-lg bg-[#F2E8DB] flex items-center justify-center shrink-0">{f.icon}</div>
                    <div>
                      <p className="text-gray-900 font-semibold text-sm mb-0.5">{f.label}</p>
                      <p className="text-[#7A6150] text-xs leading-relaxed">{f.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-[#F2E8DB]/50 border border-[#dabcac] rounded-2xl p-6">
              <p className="text-xs text-[#7A6150] uppercase tracking-wide font-semibold mb-5">Post-Adoption Timeline</p>
              <div className="space-y-5">
                {[
                  ...
                  <div key={i} className="flex gap-4 items-start">
                    <div className="flex flex-col items-center shrink-0">
                      <div className="w-10 h-10 rounded-full bg-white border-2 border-[#C4622D]/30 flex items-center justify-center">
                        <span className="text-[#C4622D] font-semibold" style={{ fontSize: '0.6rem', textAlign: 'center', lineHeight: '1.2' }}>{t.time}</span>
                      </div>
                      {i < 4 && <div className="w-px h-5 bg-[#dabcac] mt-1" />}
                    </div>
                    <div className="pb-1">
                      <p className="text-gray-900 font-semibold text-sm">{t.label}</p>
                      <p className="text-[#7A6150] text-xs mt-0.5 leading-relaxed">{t.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <section>
          <div className="flex items-center gap-3 mb-8">
            <div className="flex-1 h-px bg-[#dabcac]" />
            <h2 className="text-[#7A6150] font-semibold text-sm uppercase tracking-widest">Common Questions</h2>
            <div className="flex-1 h-px bg-[#dabcac]" />
          </div>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="bg-white border border-[#dabcac] rounded-xl p-5">
                <p className="text-gray-900 font-semibold text-sm mb-2">{faq.q}</p>
                <p className="text-[#7A6150] text-xs leading-relaxed">{faq.a}</p>
              </div>
            ))}
          </div>
        </section>

        <section className="bg-[#C4622D] rounded-2xl p-8 sm:p-10 text-center">
          <h2 className="text-white mb-3" style={{ fontFamily: "var(--font-dm-serif)", fontSize: '1.75rem' }}>
            Ready to Find Your Companion?
          </h2>
          <p className="text-white/70 mb-6 text-sm leading-relaxed max-w-md mx-auto">
